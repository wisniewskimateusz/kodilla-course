...
public class CrudAppTestSuite {
    private static final String BASE_URL = "https://wisniewskimateusz.github.io/";
    ...
    private boolean checkTaskExistsInTrello(String taskName) throws InterruptedException {
        ...
        driverTrello.findElement(By.id("user")).sendKeys("wmmateusz@gmail.com");
        driverTrello.findElement(By.id("password")).sendKeys("kodilla2021!");
